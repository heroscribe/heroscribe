...
treasure: [
  ...
  {title: "Gold!", text: "A meagre haul of just 10 gold coins is found in the pocket of a smelly, worn jerkin. Record the money on the back of your character sheet.", image: ""},
  {title: "Gold!", text: "A rummage through several items of clothing reveals 20 gold coins. Record the money on the back of your character sheet.", image: ""},
  {title: "Gold!", text: "Amidst the clutter, the old rags, the greasy fur robes and soiled blankets, you find 25 gold coins. Record the money on the back of your character sheet.", image: ""},
  {title: "Gold!", text: "Foolishly left unhidden lies a small box containing 25 gold coins. Record the money on the back of your character sheet.", image: ""},
  {title: "Gold!", text: "You find a loose stone behind which is hidden a small leather pouch wrapped in an old rag. You look inside the pouch and find 50 gold coins. Record the money on the back of your character sheet.", image: ""},
  {title: "Gold!", text: "You search and find small amounts of gold hidden in several places. But you lose track of time. Roll one die and multiply the result by ten to see how many gold coins you find. Miss your next go. Record the money on the back of your character sheet.", image: ""},
  {title: "Trap!", text: "As you search you unwittingly set off a trap. An arrow shoots out from the wall. You must lose one body point. Return this card to the treasure pile.", image: ""},
  {title: "Trap!", text: "You feel the gentle pressure of a trip wire against your leg, you spin round … but it is too late. You lose one body point from the crossbow bolt that shoots from the wall. Return this card to the treasure pile.", image: ""},
  {title: "Trap!", text: "The stone beneath your foot begins to give way and all too late you realize it is a trap. You fall into a pit and lose one Body point. You may climb out and move as normal on your next turn. The pit then closes. Return this card to the treasure pile.", image: ""},
  ...
  {title: "Nothing", text: "Despite a thorough search you find nothing.", image: "treasure_nothing2_eu"},
  {title: "Potion of Resilience", text: "Amidst a collection of old bottles and earthen jugs you find a small clear vial, a Potion of Resilience. It may be taken at any time. You may then roll two extra combat dice in defence when you next defend. The card is then discarded.", image: ""},
...
artifacts: [
  {title: "Borin's Armor", text: "Borin's Armour allows you to roll four combat dice in defence.", image: ""},
...
equipment: [
  ...
  {title: "The Helmet", text: "The helmet gives you one extra combat die in defence.", image: "", cost: "120", wizard: false, type: "armour"},
  ...
  {title: "The shield", text: "The shield gives you one extra combat die in defence.", image: "", cost: "100", wizard: false, type: "armour"},
...
equipment: [
  ...
  {title: "Longsword", text: "This long blade gives you the attack strength of 3 combat dice. Because of its length, the longsword enables you to attack diagonally.", image: "", cost: "350", wizard: false, type: "weapon"},
  {title: "Plate Mail", text: "This heavy metal armor gives you 2 extra combat dice in defense. However, because it is so heavy, you may only roll 1 red die for movement while wearing it. May be combined with the Helmet and/or Shield.", image: "", cost: "850", wizard: false, type: "weapon"},
...
artifacts: [
  {title: "Borin's Armor", text: "This magical suit of plate mail allows the wearer to roll four combat dice in defense. Unlike normal plate mail, this mysterious, ultralight metal armor does not slow down its wearer.", image: "", wizard: false},
...
treasure: [
  ...
  {title: "Hazard!", text: "While you are searching, a hidden arrow shoots from the wall striking you. You lose 1 Body Point and your turn is over. Return this card to the bottom of the deck.", image: ""},
  {title: "Hazard!", text: "Suddenly, the stone beneath your feet gives way. You fall into a shallow hole, losing 1 Body Point and ending your turn. You may climb out and move normally on your next turn. Return this card to the bottom of the deck.", image: ""},
...
chaosspells: [
  ...
  {title: "Lightning Bolt", text: "This spell may be cast in a horizontal, vertical, or diagonal direction. The bolt will travel in a straight line until it strikes a wall or closed door. It will inflict 2 points of Body damage on all Heroes or monsters that stand in its path.", image: ""},
...
artifacts: [
  ...
  {title: "Ball of Flame", text: "This spell may be cast on a monster, enveloping it in a ball of fire. It will inflict 2 Body Points of damage. The monster then rolls two red dice. For each 5 or 6 rolled, the damage is reduced by 1 point. May be used by any Hero.", image: "", type: "scroll"},
  {title: "Courage", text: "This spell may be cast on a Hero, including yourself. The next time that Hero attacks, he may roll two extra combat dice. The spell is broken the moment the Hero can no longer \"see\" a monster. May be used by any Hero.", image: "", type: "scroll"},
  {title: "Fire of Wrath", text: "This spell may be cast on a monster, blasting it with flames. It will inflict 1 Body Point of damage, unless the monster can immediately roll a 5 or 6 using one red die. May be used by any Hero.", image: "", type: "scroll"},
  {title: "Genie", text: "This spell conjures up a Genie who will do one of the following: open any door on the gameboard (revealing what lies beyond), OR use five combat dice to attack a monster within your line of sight. May be used by any Hero.", image: "", type: "scroll"},
  {title: "Heal Body", text: "This spell may be cast on a Hero, including yourself. Its magical power will immediately restore up to 4 lost Body Points, but does not give a Hero more than his starting number. May be used by any Hero.", image: "", type: "scroll"},
  {title: "Rock Skin", text: "This spell may be cast on a Hero, including yourself. That Hero may roll one extra combat die when defending. The spell is broken when the Hero suffers 1 Body Point of damage. May be used by any Hero.", image: "", type: "scroll"},
  {title: "Sleep", text: "This spell puts a monster into a deep sleep so it cannot move, attack, or defend itself. The spell can be broken at once or on a future turn by a monster rolling one red die for each of its Mind Points. If a 6 is rolled, the spell is broken. May not be used against Mummies, Zombies or Skeletons. May be used by any Hero.", image: "", type: "scroll"},
  {title: "Tempest", text: "This spell may be cast on a monster, surrounding it with a small whirlwind. That monster will then miss its next turn. May be used by any Hero.", image: ""},
],
}
rotwl_cards = {
artifacts: [
  ...
  {title: "Fire of Wrath", text: "This spell may be cast on a monster, blasting it with flames. It will inflict 1 Body Point of damage, unless the monster can immediately roll a 5 or 6 using one red die. May be used by any Hero.", image: "", type: "scroll"},
  {title: "Genie", text: "This spell conjures up a Genie who will do one of the following: open any door on the gameboard (revealing what lies beyond), OR use five combat dice to attack a monster within your line of sight. May be used by any Hero.", image: "", type: "scroll"},
  {title: "Pass Through Rock", text: "This spell may be cast on a Hero, including yourself. That Hero may then move through walls on his next move. He may move through as many walls as his dice roll allows. Caution! There are shaded areas on each Quest Map which indicate solid rock. If a Hero ends his move in one of these areas, he is trapped forever! May be used by any Hero.", image: "", type: "scroll"},
],
}
sets = [
  {name: "Quest Treasure", region: "EU", cards: eu_cards.artifacts},
  {name: "Air Spells", region: "EU", cards: eu_cards.airspells},
  {name: "Earth Spells", region: "EU", cards: eu_cards.earthspells},
  {name: "Fire Spells", region: "EU", cards: eu_cards.firespells},
  {name: "Water Spells", region: "EU", cards: eu_cards.waterspells},
  {name: "Treasure", region: "EU", cards: eu_cards.treasure},
  {name: "Equipment", region: "EU", cards: eu_cards.equipment},
  {name: "Artifacts", region: "US", cards: us_cards.artifacts},
  {name: "Air Spells", region: "US", cards: us_cards.airspells},
  {name: "Earth Spells", region: "US", cards: us_cards.earthspells},
  {name: "Fire Spells", region: "US", cards: us_cards.firespells},
  {name: "Water Spells", region: "US", cards: us_cards.waterspells},
  {name: "Chaos Spells", region: "US", cards: us_cards.chaosspells},
  {name: "Treasure", region: "US", cards: us_cards.treasure},
  {name: "Equipment", region: "US", cards: us_cards.equipment},
  {name: "Kellar's Keep", region: "US", cards: kk_cards.artifacts},
  {name: "Return of the Witch Lord", region: "US", cards: rotwl_cards.artifacts},
];
